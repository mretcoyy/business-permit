    ...
    >
        <a-form :form="form">
                            ...
                            v-decorator="[
                                'dtiSecNo',
                                {
                                    rules: [
                                        {
                                            required: true,
                                            message: 'DTI sec. no. is required',
                                        },
                                    ],
                                },
                            ]"
                            ...
                            v-decorator="[
                                'BAddressHouseNo',
                                {
                                    rules: [
                                        {
                                            required: true,
                                            message: 'Business No. is required',
                                        },
                                    ],
                                },
                            ]"
            ...
            <p style="padding-left: 9px">
                ...
                <a-form-item>
                    <a-checkbox v-model="is_lessor" style="font-weight: bold"
                        >Check if Place of Business is Rented, please identify
                        the following</a-checkbox
                    >
                </a-form-item>
            </p>
